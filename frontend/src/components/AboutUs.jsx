      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Us</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">Trust & Security</h3>
            <p className="text-slate-400 text-sm">Your data security is our top priority. We use industry-standard encryption and security practices.</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            ...
            <p className="text-slate-400 text-sm">We continuously evolve our platform with new features and improvements based on customer feedback.</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
            ...
            <h3 className="text-white font-semibold text-lg mb-2">Customer Focus</h3>
            <p className="text-slate-400 text-sm">Our customers are at the heart of everything we do. Your success is our success.</p>
          </div>
        </div>
                ...
                <div key={member.id} className="text-center">
                  {member.image_url ? (
                    <img
                      ...
                      alt={member.name}
                      className="w-20 h-20 rounded-full object-cover mx-auto mb-3 border-2 border-indigo-500/50"
                    />
                  ) : (
                  ...
                  {member.bio && (
                    <p className="text-slate-500 text-xs mt-2 line-clamp-2">{member.bio}</p>
                  )}
                </div>
              ))}
            </div>
