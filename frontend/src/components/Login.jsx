...
export default function Login({
  ...
  // ── Embedded mode (hideCredentials=true): render only the form ──
  if (hideCredentials) {
    if (twoColumnLayout) {
      return (
        <div className="grid grid-cols-1 gap-4">
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold rounded-xl py-3 text-sm transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
              >
                {loading ? (
                  <>
          ...
          {/* <div className="bg-gray-50 rounded-xl p-4">
            <p className="text-xs text-gray-600 text-center mb-3 font-medium uppercase tracking-wider">Demo Credentials</p>
            <div className="space-y-2">
              <button
                type="button"
                onClick={() => { setEmail('restricted'); setPassword('******'); }}
                className="flex items-center gap-3 w-full text-left bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg px-3 py-2.5 transition-colors group"
              >
                <span className="text-xs font-bold bg-red-100 text-red-600 px-2 py-0.5 rounded-full shrink-0">SUPER ADMIN</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">Restricted!!!</span>
              </button>
              <button
                type="button"
                onClick={() => { setEmail('alice@boutique.com'); setPassword('alice123'); }}
                className="flex items-center gap-3 w-full text-left bg-white hover:bg-gray-100 border border-gray-200 rounded-lg px-3 py-2.5 transition-colors group"
              >
                <span className="text-xs font-bold bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full shrink-0">SHOP ADMIN</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">alice@boutique.com · alice123</span>
              </button>
              <button
                type="button"
              ...
              >
                <span className="text-xs font-bold bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full shrink-0">SHOP ADMIN</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">admin@mkfashion.com · mkfashion123</span>
              </button>
              <button
                type="button"
              ...
              >
                <span className="text-xs font-bold bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full shrink-0">SHOP ADMIN</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">admin@mkpharmacy.com · mkpharmacy123</span>
              </button>
              <button
                type="button"
                ...
                className="flex items-center gap-3 w-full text-left bg-white hover:bg-gray-100 border border-gray-200 rounded-lg px-3 py-2.5 transition-colors group"
              >
                <span className="text-xs font-bold bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full shrink-0">SHOP STAFF</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">staff1@mkpharmacy.com · staff123</span>
              </button>
              <button
                type="button"
              ...
              >
                <span className="text-xs font-bold bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full shrink-0">SHOP STAFF</span>
                <span className="text-xs text-gray-500 group-hover:text-gray-700 transition-colors truncate">staff1@mkfashion.com · staff123</span>
              </button>
            </div>
          </div> */}
        </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 dark:bg-slate-900 relative overflow-hidden">

      {/* Animated background blobs */}
      <div className="absolute top-[-10%] left-[-5%] w-96 h-96 bg-slate-600/20 dark:bg-slate-700/20 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-[-10%] right-[-5%] w-96 h-96 bg-violet-600/20 dark:bg-violet-700/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            ...
            <span className="text-emerald-400">-Pharma</span>
          </h1>
        ...
        <p className="text-center text-slate-600 dark:text-slate-500 text-xs mt-6">
          ...
          developed by <a href="https://its-mk.netlify.app/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-400 dark:hover:text-indigo-300 transition-colors">MK</a>
        </p>
      </div>
    </div>
  );
