        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">support@possystem.com</p>
                    <p className="text-gray-600 text-sm">info@possystem.com</p>
                  </div>
                </div>
